    ...
    justify-between md:px-36 px-8 md:pt-30 pt-20 text-left"
      ...
      bg-gradient-to-b from-cyan-100/70"
        ...
        <div className="max-w-2xl z-10 text-gray-500">
          ...
          <p
            className="pt-4 text-sm md:text-base leading-relaxed"
          ...
          <p>Course by <span className="text-blue-600 
        ...
        {/* right colum */}
        <div className="max-w-course-card z-10 shadown-custom-card rounded-t
